...
function AvisoLegal() {
  return (
    <>
      <ScrollArriba />
      <HeaderSeccion nombre="Aviso Legal" />
      <section className='politica d-flex-col'>
        <p>Denominación Social: GRUPO LAMARTA, S.L</p>
        <p>Domicilio Social: ARZOBISPO XELMIREZ, 7 36600, VILAGARCIA DE AROUSA</p>
        <p>NIF: B56603095</p>
        <p>Teléfono: 664 36 86 61</p>
        <p>e-Mail: grupolamarta@gmail.com</p>
        <p>Nombre de dominio: https://lamarta.es/</p>
        ...
        <article className="politica--apartado">
            ...
            <p>GRUPO LAMARTA, S.L titular del portal   https://lamarta.es/ , informa a los usuarios del mismo, en adelante el “portal”, que GRUPO LAMARTA, S.L es responsable de los tratamientos que se realicen mediante este portal, salvo que otra cosa se informe en el tratamiento de que se trate.</p>
            <p>GRUPO LAMARTA, S.L respeta la legislación vigente en materia de protección de datos personales, la privacidad de los usuarios y el secreto y seguridad de los datos personales, de conformidad con lo establecido en la legislación aplicable en materia de protección de datos, en concreto, el Reglamento 2016/679 del Parlamento Europeo y del Consejo de 27 de abril de 2016, adoptando para ello las medidas técnicas y organizativas necesarias para evitar la pérdida, mal uso, alteración, acceso no autorizado y robo de los datos personales facilitados, habida cuenta del estado de la tecnología, la naturaleza de los datos y los riesgos a los que están expuestos.</p>
            ...
            <ul>
                ...
                <li>Los datos de contacto del Delegado de Protección de Datos, si procede.</li>
        ...
        <article className="politica--apartado">
            ...
            <p>Para realizar cualquier tipo de observación respecto a posibles incumplimientos de los derechos de propiedad intelectual o industrial, así como sobre cualquiera de los contenidos del sitio web, puede hacerlo a través del siguiente correo electrónico: grupolamarta@gmail.com</p>
        </article>
